export const translations = {
  es: {
    welcome: 'Bienvenido',
    subtitle: 'Accede a todas las aplicaciones de la empresa',
    errorTitle: 'Error al cargar las aplicaciones',
  ...
  pt: {
    welcome: 'Bem-vindo',
    subtitle: 'Aceda a todas as aplicações da empresa',
    errorTitle: 'Erro ao carregar as aplicações',
